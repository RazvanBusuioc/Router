...
#define INVALID 0
#define TABLE_MAX_SIZE 64000
#define ETH_HSIZE (sizeof(struct ether_header))
#define ARP_HSIZE (sizeof(struct ether_arp))
...
/*Checksum function for ip and icmp headers*/
uint16_t checksum(void *vdata, size_t length);

/*Checksum updating after ttl decrementation*/
void incremental_updating_checksum(struct iphdr *ip_hdr);